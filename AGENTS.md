...
- TypeScript 5.x on Node.js 22 (backend), TypeScript 5.7 + React 19 + Next.js App Router (frontend) + Express, pg, OpenAI SDK, Zod, Pino, Next.js, shadcn/ui, Radix UI primitives, Lucide icons (019-token-usage-ledger)
- PostgreSQL 16+ with `pgvector`; additive usage ledger and daily summary tables (019-token-usage-ledger)
...
## Recent Changes
- 019-token-usage-ledger: Added TypeScript 5.x on Node.js 22 (backend), TypeScript 5.7 + React 19 + Next.js App Router (frontend) + Express, pg, OpenAI SDK, Zod, Pino, Next.js, shadcn/ui, Radix UI primitives, Lucide icons
