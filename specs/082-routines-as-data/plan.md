...
- **Tests**: one message providing N facts advances past all N satisfied steps in that turn (no intermediate prompt); partial provision asks only for the missing slot; typed-slot extraction/validation.
