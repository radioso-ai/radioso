...
Revoked credentials are kept under **Revoked access**. Expand it to inspect their details. To let this agent call tools or other agents, open **Skills → Manage MCP connections** and add a connection in the side panel.
