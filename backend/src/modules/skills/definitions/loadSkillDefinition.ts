...
const validateGeneratedContractReferences = (definition: SkillDefinition, definitionRootUrl: URL): void => {
...
/**
 * Loads and validates a declarative skill definition from its directory (which
 * contains a `skill.json`, and optionally a generated contract). Shared by every
