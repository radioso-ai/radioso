...
export const copilotApplicationPrimitiveRegistry = {
  ...
  "documents.reviewed-operation": { owningModule: "documents", exportedPort: "DocumentReviewedOperationService" },
  ...
  "websiteCrawler.crawl.propose": { owningModule: "websiteCrawler", exportedPort: "WebsiteCrawlJobService" },
