...
const cursorUsage = `Usage:
  RADIOSO_WORKSPACE_TOKEN=sk_proj_... npm --prefix packages/radioso-mcp-server run -s cursor:prepare
...
Examples:
  RADIOSO_WORKSPACE_TOKEN=sk_proj_... npm --prefix packages/radioso-mcp-server run -s cursor:prepare
  RADIOSO_WORKSPACE_TOKEN=sk_proj_... npm --prefix packages/radioso-mcp-server run -s cursor:prepare -- --open
`;
