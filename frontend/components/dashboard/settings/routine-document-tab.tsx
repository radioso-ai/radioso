...
export function RoutineDocumentTab({ draft, isReadOnly = true, onDraftChange, diagnostics }: { draft: RoutineDefinitionDraft; isReadOnly?: boolean; onDraftChange?: (draft: RoutineDefinitionDraft) => void; diagnostics?: RoutineValidationDiagnostic[] }) {
  ...
  return isReadOnly || !onDraftChange ? <RoutineDocumentReader doc={result.doc} /> : <DocumentEditor initialDoc={result.doc} onDraftChange={onDraftChange} diagnostics={diagnostics} />
}
