...
While the worker chews through your upload, the Documents list is where you watch it happen. A document is only a retrieval candidate once its status reads Ready.
