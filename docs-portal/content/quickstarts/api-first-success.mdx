...
description: Reach first success with plain HTTP by registering, getting a token, uploading content, and asking a knowledge agent a grounded question.
---
...
You can use Radioso without opening the web app. This path is for teams that already know they want knowledge-agent behavior but want to integrate it behind their own scripts, jobs, or UI first.
...
5. ask one agent question whose answer should obviously come from that document
