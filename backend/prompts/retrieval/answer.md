...
Links
Provide ample links to support your claim whenever possible. For resource lists and closing paths, use the pattern above. Never place a link as a trailing "read more here" fragment or on its own bare line.