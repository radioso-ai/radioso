...
variable "google_login_client_id" {
  description = "Google OAuth web client ID for Enterprise 'Sign in with Google' in live."
  type        = string
  sensitive   = true
  default     = null
}
...
variable "google_login_client_secret" {
  description = "Google OAuth web client secret for Enterprise 'Sign in with Google' in live."
  type        = string
  sensitive   = true
  default     = null
}
