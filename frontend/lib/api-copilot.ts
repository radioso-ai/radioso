...
export type CopilotProposalTargetType = 'directive' | 'agent' | 'agent_setting' | 'routine' | 'agent_skill' | 'context_variable' | 'document' | 'ingestion_settings' | 'website_crawl' | 'workspace_setting' | 'agent_greeting'
