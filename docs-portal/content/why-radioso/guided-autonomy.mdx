...
Operators work in the dashboard **Activity → Inbox** or through authenticated endpoints under `/api/v1/conversations`. Escalations — an approval to decide, a handoff waiting or held — sort to the top. Selecting one opens the full transcript with message attribution and a reply composer that claims the item as soon as you send, plus actions to hand back and resolve a pending decision.
