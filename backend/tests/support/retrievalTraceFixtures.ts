...
// One decomposed two-subquery retrieval turn, shared by the activity trace assembler
// tests and the pipeline trace builder tests so both describe the same turn.
export const activityTraceInputFixture = (): ActivityTraceAssemblerInput => ({
  prompt: {
    request: {
      workspaceId: "w1",
    ...
    semanticRetrievalStartedAtMs: Date.parse("2026-04-12T14:14:16.030Z"),
    semanticRetrievalDurationMs: 600,
    lexicalRetrievalStartedAtMs: Date.parse("2026-04-12T14:14:16.005Z"),
