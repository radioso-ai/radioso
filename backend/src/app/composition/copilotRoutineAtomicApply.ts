...
const applyOn = async (
...
): Promise<{ readonly appliedRef: { readonly agentId: string; readonly routineId: string }; readonly routine?: import("../../modules/routines/public.js").RoutineDefinition }> => {
  ...
  if (input.operation === "delete") {
    ...
    if (deleted.outcome !== "deleted") throw new Error("routine_definition_delete_conflict");
