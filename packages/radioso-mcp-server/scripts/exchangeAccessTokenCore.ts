...
export const usage = `Usage:
  RADIOSO_WORKSPACE_TOKEN=radioso_... pnpm --dir packages/radioso-mcp-server run -s token:exchange
...
Examples:
  source <(RADIOSO_WORKSPACE_TOKEN=radioso_... pnpm --dir packages/radioso-mcp-server run -s token:exchange)
  RADIOSO_WORKSPACE_TOKEN=radioso_... pnpm --dir packages/radioso-mcp-server run -s token:exchange -- --format json
`;
