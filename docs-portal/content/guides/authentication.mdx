...
Use session auth to reach the workspace's API access controls. Service accounts have their own **Settings → Service accounts** page. Credential lifecycle operations accept only the signed-in session.
