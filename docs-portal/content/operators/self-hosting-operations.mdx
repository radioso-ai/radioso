...
This stream accepts the dashboard session cookie rather than workspace API tokens. It is used by the dashboard itself and is not an SDK or MCP event subscription API.
