...
export const catalogCoverage: Record<string, CatalogCoverageEntry> = {
  ...
  updateAgentRoutinePortableDocument: { excluded: "Routine proposals create drafts only; editing remains in the routine editor." },
  draftAgentRoutineFromProcedure: { excluded: "Routine proposals create drafts only; editing remains in the routine editor." },
  createAgentRoutinePortableDocument: { excluded: "Routine proposals create drafts only; portable authoring remains in the routine editor." },
  canonicalizeRoutinePortableDocument: { excluded: "Portable routine editing remains in the routine editor." },
