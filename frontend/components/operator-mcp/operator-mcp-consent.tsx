    ...
    <ConsentShell>
      <Card className="w-full max-w-2xl">
        ...
        <CardContent className="space-y-5">
          ...
          <div className="flex justify-end gap-2"><Button type="button" variant="outline" onClick={() => void decide('deny')} disabled={submitting}>Don&apos;t approve</Button><Button type="button" onClick={() => void decide('approve')} disabled={decisionUnavailable} loading={submitting} icon={<CheckCircle2 />}>Approve access</Button></div>
        </CardContent>
      </Card>
    </ConsentShell>
  )
