...
export const inlineSupportedLinksDirective: Directive = {
  ...
  action: [
    "When you name or reference a page, site, course, event, video, or resource that has a URL in the retrieved findings, link it inline with Markdown by turning the resource's own name or description into the link, within the sentence that mentions it. Never invent links.",
    "Don't tell the user to go to, open, use, submit, register, book, contact, download, read, or learn more from a supported page, unless that you supply that action phrase or page with an inline Markdown link to the supported URL.",
