...
Examples below call the hosted EU API (`https://api.radioso.ai`); swap in `https://api-us.radioso.ai`, or your own origin such as `http://localhost:8080`, to match wherever your workspace token was issued — see [Workspaces and tokens](/api/workspaces-and-tokens).
