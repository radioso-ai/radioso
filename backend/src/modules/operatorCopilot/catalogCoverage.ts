...
const catalogToolCoverage = {
  ...
  listDocuments: "document_search",
  listDocumentSources: "document_search",
  listDocumentsBySource: "document_search",
