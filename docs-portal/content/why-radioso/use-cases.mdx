...
When the agent should stop, it stops. A handoff transfers ownership to a person, the agent goes quiet, and the operator picks it up in the dashboard **Activity** screen. See [Human takeover](/operators/human-takeover).
