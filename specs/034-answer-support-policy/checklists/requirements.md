# Specification Quality Checklist: Configurable Answer Support Policy
...
- Scope is intentionally limited to workspace-level policy selection and does
  not change support-detection heuristics, retrieval ranking, or per-user
  overrides.
