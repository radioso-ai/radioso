...
module "radioso" {
  ...
  operator_mcp_enabled                        = var.operator_mcp_enabled
  operator_mcp_public_origin                  = var.operator_mcp_public_origin
  operator_mcp_credential_epoch               = var.operator_mcp_credential_epoch
  operator_mcp_rollout_workspace_ids          = var.operator_mcp_rollout_workspace_ids
  operator_mcp_verification_budget_per_minute = var.operator_mcp_verification_budget_per_minute
