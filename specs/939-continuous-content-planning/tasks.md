...
- [X] T012 [Codex] Add `backend/src/db/migrations/134_content_planning.sql`; regenerate `backend/src/db/schema.sql` and `backend/src/shared/infra/kysely/schema.ts`
