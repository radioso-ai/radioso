...
import { realCatalog, realCatalogDependencies } from "./realCatalogTestSupport.js";
...
// realCatalog/realCatalogDependencies exercise the REAL composition barrel rather than
// re-wiring the factories by hand. The other suites build descriptors factory-by-factory, which
// means they wire dependencies correctly themselves and can never catch the barrel wiring them
// wrongly — which is exactly how a dead tool and a dead name-resolution path both reached main.
