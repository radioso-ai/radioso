    ...
    <aside className="flex w-full shrink-0 flex-col border-border md:w-[360px] md:border-r" aria-label="Inbox queue">
      <div className="shrink-0 space-y-2 border-b border-border p-3">
        ...
        <div className="flex gap-1.5">
          ...
          >
            <SelectTrigger size="sm" className="h-8 flex-1 text-xs" aria-label="Filter by type">
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
          ...
          >
            <SelectTrigger size="sm" className="h-8 flex-1 text-xs" aria-label="Filter by taken by">
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
