...
const dependencies = () => {
  ...
  return {
    ...
    directiveAuthor: { draftForProposal: vi.fn(async () => ({ draft: { directive: { name: "quote-primary", condition: { kind: "always" as const }, action: "Use **this exact text**.", excludes: [], tags: [], surfaces: [] } }, versionToken: "2026-09-26T09:00:00.000Z", current: null, drafting: "verbatim" as const })), readProposalFence: vi.fn(async () => "2026-09-26T09:00:00.000Z") }, directives: { previewChange },
  };
};
