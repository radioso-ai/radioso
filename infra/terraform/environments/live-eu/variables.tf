...
variable "mcp_public_origin" {
  description = "Optional canonical HTTPS origin for standalone MCP in EU live. GitHub Actions discovers the Cloud Run URL; set this only for a custom domain or direct Terraform run."
  type        = string
  default     = null
}
