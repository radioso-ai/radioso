...
The workbench drives the same assistant chat API that end-user surfaces use — the assistant chat API is how you talk to an agent — so what you see here is what a visitor gets.
