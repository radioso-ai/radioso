...
function DocumentEditor({ initialDoc, onDraftChange, diagnostics }: { initialDoc: RoutineBlockDoc; onDraftChange: (draft: RoutineDefinitionDraft) => void; diagnostics?: RoutineValidationDiagnostic[] }) {
  ...
  return <article className="space-y-8 rounded-lg border border-border bg-background p-5" aria-label="Routine document editor">
...
export function RoutineDocumentTab({ draft, onDraftChange, diagnostics }: { draft: RoutineDefinitionDraft; onDraftChange: (draft: RoutineDefinitionDraft) => void; diagnostics?: RoutineValidationDiagnostic[] }) {
  ...
  return <DocumentEditor initialDoc={result.doc} onDraftChange={onDraftChange} diagnostics={diagnostics} />
}
