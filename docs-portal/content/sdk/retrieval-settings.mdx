...
- If the answer contains unsupported claims even when citations look plausible, keep answer support validation enabled and inspect the response diagnostics.
