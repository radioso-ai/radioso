...
After a successful launch, the channels settings screen shows when the website embed credential was last used. If an install code is exposed, revoke it to stop new launches immediately. Revocation does not create a replacement code; rotate the credential when you're ready to install a new one.
