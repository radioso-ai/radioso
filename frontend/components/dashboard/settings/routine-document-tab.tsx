    ...
    <section aria-labelledby="routine-document-steps" className="space-y-1">
      ...
      <ol>
        ...
        <li className="group/insertafter relative flex items-start gap-3 rounded-md px-2 py-2 transition-colors hover:bg-muted/40">
          ...
          <button type="button" aria-label="Add step" onClick={addChatStep} className="min-w-0 flex-1 text-left text-sm text-muted-foreground/60 hover:text-muted-foreground">Write the next step…</button>
        </li>
      </ol>
    </section>
    <div className="border-t border-border" />
