...
export const retrieveCapability: SkillCapabilityDescriptor<"retrieve", "retrieve"> = {
  ...
  settingsFields: [
    ...
    },
    {
      ...
      type: "boolean",
      help: "Use extracted event dates to retrieve ongoing and upcoming event evidence for listing-style event date questions.",
    ...
    },
    {
      ...
      type: "boolean",
      help: "Boost ongoing or upcoming dated event evidence during event date lookups.",
      group: "Temporal retrieval",
      advanced: true,
    },
    {
      ...
      type: "boolean",
      help: "Allow date-aware deterministic ordering for temporal event answers when that ordering stage is enabled.",
      group: "Temporal retrieval",
      advanced: true,
    },
    {
