...
- [ ] T022 [US1] Observability: span/metric per external tool invocation (connection/server id, tool name, outcome status, latency) — NO payloads/PII/tokens — in the executor; reuse existing tracing/metrics infra.
