...
variable "mail_smtp_host" {
  description = "Optional SMTP host for future live email delivery."
  type        = string
  default     = null
}

variable "mail_smtp_port" {
  description = "Optional SMTP port for future live email delivery."
  type        = number
  default     = 587
}

variable "mail_smtp_secure" {
  description = "Whether future live SMTP uses implicit TLS."
  type        = bool
  default     = false
}

variable "mail_smtp_username" {
  description = "Optional SMTP username for live."
  type        = string
  sensitive   = true
  default     = null
}
...
variable "mail_smtp_password" {
  description = "Optional SMTP password for live."
  type        = string
  sensitive   = true
  default     = null
}
