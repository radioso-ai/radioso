...
Validate that Radioso preserves live chat as an interactive synchronous path while documenting and classifying long-running assistant work as explicitly deferred background work.
...
4. Review the updated operator-facing documentation and confirm it explains:
   ...
   - which workflows are background
...
2. Confirm any referenced deferred workflow is described as background work from the start, not as a delayed version of normal chat.
