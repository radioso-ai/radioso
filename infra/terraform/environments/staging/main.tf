...
module "radioso" {
  ...
  worker_task_queue_name                = "radioso-staging-document-processing"
  worker_crawl_task_queue_name          = "radioso-staging-website-crawls"
