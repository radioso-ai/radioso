...
In **Activity → Quality**, resolve or dismiss a turn with a structured reason.
After you change knowledge, retrieval, behavior, or platform code, run the linked
Eval. Quality shows timestamped passing or failing evidence beside the turn. A
pass offers **Review and resolve**, but Radioso still asks you to choose the
reason; a test result never closes operator work automatically.
